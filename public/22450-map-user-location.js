...
(function() {
  ...
  function initUserLocationMap(containerIdOrElement) {
    ...
    var api = { map: map, showMyLocation: showMyLocation, hideMyLocation: hideMyLocation, toggleMyLocation: toggleMyLocation, getCenterCoords: getCenterCoords, getUserLocation: getUserLocation };
    if (typeof window.onUserLocationMapReady === 'function') window.onUserLocationMapReady(map, api);
    return api;
  }
